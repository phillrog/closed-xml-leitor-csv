...
namespace ClosedXML.LerCsv
{
	...
	public class CsvReader
	{
		...
		public CsvReader(TextReader rdr, string delimiter, int bufferSize = 32768)
		{
			this.rdr = rdr;
			Delimiter = delimiter;
		...
		{
			return fields.Count > 0 ? string.Join(Delimiter, fields.Select(d => d.GetValue(buffer)).ToList()) : "";
		}
